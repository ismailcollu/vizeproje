...
Public Class ApplicationUserManager
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationUserManager), context As IOwinContext) As ApplicationUserManager
        ...
        manager.RegisterTwoFactorProvider("Telefon Kodu", New PhoneNumberTokenProvider(Of ApplicationUser) With {
                                          .MessageFormat = "Güvenlik kodunuz: {0}"
                                      })
        manager.RegisterTwoFactorProvider("E-posta Kodu", New EmailTokenProvider(Of ApplicationUser) With {
